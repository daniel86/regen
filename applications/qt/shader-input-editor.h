...
public:
	...
	void setupUi(QWidget *shaderInputEditor) {
		...
		QObject::connect(treeWidget, SIGNAL(currentItemChanged(QTreeWidgetItem * , QTreeWidgetItem * )),
						 shaderInputEditor, SLOT(activateValue(QTreeWidgetItem * , QTreeWidgetItem * )));
