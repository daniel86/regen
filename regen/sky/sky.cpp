...
const Vec3f& Sky::noonColor()
{ return noonColor_; }
void Sky::set_noonColor(const Vec3f &noonColor)
{ noonColor_ = noonColor; }

const Vec3f& Sky::dawnColor()
{ return dawnColor_; }
void Sky::set_dawnColor(const Vec3f &dawnColor)
{ dawnColor_ = dawnColor; }

GLfloat Sky::moonSunLightReflectance()
{ return moonSunLightReflectance_; }
void Sky::set_moonSunLightReflectance(GLfloat moonSunLightReflectance)
{ moonSunLightReflectance_ = moonSunLightReflectance; }
