...
GLdouble MoonLayer::defaultScattering()
{ return 4.0; }
...
void MoonLayer::set_scattering(GLdouble scattering)
{ scattering_->setVertex(0, scattering); }

const ref_ptr<ShaderInput1f>& MoonLayer::scattering() const
{ return scattering_; }
