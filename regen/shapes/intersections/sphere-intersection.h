...
namespace regen {
	...
	struct BatchIntersection_Sphere_Boxes : BatchedIntersectionCase {
		BatchIntersection_Sphere_Boxes() = default;
		~BatchIntersection_Sphere_Boxes() override = default;
	};
	...
	namespace shapes {
		...
		void flush_Sphere_Boxes(BatchedIntersectionCase&);
	...
	template<> struct IntersectionTraits<IntersectionShapeType::SPHERE, IntersectionShapeType::AABB> {
		using CaseType = BatchIntersection_Sphere_Boxes;
		static constexpr auto Case = IntersectionCaseType::SPHERE_BOXES;
		static constexpr auto Init = BatchedIntersectionCase::case_NOOP;
		static constexpr auto Flush = shapes::flush_Sphere_Boxes;
	};
