...
#endif
	Vec3i vec3_val;
	glGetIntegeri_v(GL_MAX_COMPUTE_WORK_GROUP_SIZE, 0, &vec3_val.x);
	glGetIntegeri_v(GL_MAX_COMPUTE_WORK_GROUP_SIZE, 1, &vec3_val.y);
	glGetIntegeri_v(GL_MAX_COMPUTE_WORK_GROUP_SIZE, 2, &vec3_val.z);
	REGEN_DEBUG("MAX_COMPUTE_WORK_GROUP_SIZE: " << vec3_val);
	glGetIntegeri_v(GL_MAX_COMPUTE_WORK_GROUP_COUNT, 0, &vec3_val.x);
	glGetIntegeri_v(GL_MAX_COMPUTE_WORK_GROUP_COUNT, 1, &vec3_val.y);
	glGetIntegeri_v(GL_MAX_COMPUTE_WORK_GROUP_COUNT, 2, &vec3_val.z);
	REGEN_DEBUG("MAX_COMPUTE_WORK_GROUP_COUNT: " << vec3_val);
	DEBUG_GLi("MAX_COMPUTE_SHARED_MEMORY_SIZE", GL_MAX_COMPUTE_SHARED_MEMORY_SIZE);
#undef DEBUG_GLi
