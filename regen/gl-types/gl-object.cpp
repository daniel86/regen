...
const ref_ptr<ShaderInput2f>& GLRectangle::sizeInverse() const
{ return sizeInverse_; }
const ref_ptr<ShaderInput2f>& GLRectangle::size() const
{ return size_; }

GLuint GLRectangle::width() const
{ return size_->getVertex(0).x; }
GLuint GLRectangle::height() const
{ return size_->getVertex(0).y; }
